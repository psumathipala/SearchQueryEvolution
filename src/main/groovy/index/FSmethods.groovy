...
/**
 * The feature selection methods (F1, TFIDF, IG, OR, Chi, Merge) have implemented ih this class. They returns
 * important term for each methods.
 *     getF1TermQueryList()
 *     getTFIDFTermQueryList()
 *     getTFIDFTermQueryListForCategory()
 *     getIGTermQueryList()
 *     getORTermQueryList()
 *     getChiTermQueryList()
 *     mergeMethods()
...
class FSmethods implements FeatureSelection{
